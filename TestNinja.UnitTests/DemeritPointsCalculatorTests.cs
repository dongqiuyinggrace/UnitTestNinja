...
namespace TestNinja.UnitTests
{
    ...
    public class DemeritPointsCalculatorTests
    {
        ...
        [TestCase(-1)]
        [TestCase(301)]
        public void CalculateDemeritPoints_OutOfRangeSpeed_ThrowArgumentOutOfRangeException(int speed)
        {
        ...
        [TestCase(65)]
        [TestCase(30)]
        public void CalculateDemeritPoints_SpeedWithinSpeedLimit_ReturnZero(int speed)
        {
            var calculator = new DemeritPointsCalculator();
